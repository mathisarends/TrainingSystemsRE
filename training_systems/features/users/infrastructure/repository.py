...
from training_systems.features.users.domain.repository import UserRepository
from training_systems.infrastructure.database import SqlRepository
from training_systems.infrastructure.database.orm import UserModel
