...
from training_systems.features.plans.domain.entities import Day, Entry, Plan, Week
from training_systems.features.plans.domain.repository import PlanRepository
from training_systems.infrastructure.database.orm import (
    PlanDayModel,
    PlanEntryModel,
    PlanModel,
    PlanWeekModel,
