...
from training_systems.features.authentication.presentation.cookies import (
    clear_auth_cookies,
    set_auth_cookies,
)
...
from training_systems.features.authentication.presentation.oauth_popup import (
    OAuthPopupResponse,
)
from training_systems.features.authentication.presentation.oauth_state_cookies import (
    GoogleOAuthStateCookies,
)
from training_systems.features.authentication.presentation.schemas import (
    LoginRequest,
    RegisterRequest,
)
from training_systems.features.users.presentation.mapper import to_response
from training_systems.features.users.presentation.schemas import UserResponse
