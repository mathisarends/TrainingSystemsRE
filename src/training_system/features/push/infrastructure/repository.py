...
from training_system.features.push.domain.entities import PushSubscription
from training_system.features.push.domain.repository import (
    PushSubscriptionRepository,
)
from training_system.infrastructure.database.orm import PushSubscriptionModel
